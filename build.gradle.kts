...
kotlin {
    ...
    sourceSets {
        ...
        val jsMain by getting {
            ...
            languageSettings.optIn("kotlinx.serialization.ExperimentalSerializationApi")
            dependencies {
                implementation("org.jetbrains.kotlin-wrappers:kotlin-extensions:1.0.1-pre.268-kotlin-1.6.0")
                implementation("org.jetbrains.kotlin-wrappers:kotlin-react:17.0.2-pre.268-kotlin-1.6.0")
                implementation("org.jetbrains.kotlin-wrappers:kotlin-react-dom:17.0.2-pre.268-kotlin-1.6.0")
                implementation("org.jetbrains.kotlin-wrappers:kotlin-react-router-dom:6.0.2-pre.268-kotlin-1.6.0")
