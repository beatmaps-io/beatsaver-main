    ...
    sourceSets {
        ...
        val jsMain by getting {
            ...
            dependencies {
                ...
                implementation("org.jetbrains.kotlin-wrappers:kotlin-react-dom:17.0.2-pre.280-kotlin-1.6.0")
                implementation("org.jetbrains.kotlin-wrappers:kotlin-react-router-dom:6.1.1-pre.280-kotlin-1.6.0")
